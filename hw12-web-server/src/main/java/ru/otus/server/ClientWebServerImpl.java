...
public class ClientWebServerImpl implements ClientWebServer {
    ...
    public ClientWebServerImpl(BasicAuthService basicAuthService, DBServiceClient dbServiceClient, Gson gson, TemplateProcessor templateProcessor, int port) {
    ...
    protected Handler applySecurity(ServletContextHandler servletContextHandler, String... paths) {
        servletContextHandler.addServlet(new ServletHolder(new LoginServlet(templateProcessor, basicAuthService)), "/login");
